...
export default function IndianMSMEClinicPage() {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-8 sm:py-20 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-16 space-y-2 sm:space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-primary">Overcoming Shop-Floor Challenges</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={idx} className="bg-white border border-slate-200/60 rounded-xl p-4 sm:p-5 shadow-xs">
                <h3 className="font-serif text-sm font-bold text-primary mb-1.5 sm:mb-2">0{idx + 1}. {p.title}</h3>
      ...
      <section className="py-8 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-16 space-y-2 sm:space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-primary">Operational Growth Clinic</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {pillars.map((p) => {
              const Icon = p.icon;
              return (
                <div key={p.title} className="bg-slate-50 border border-slate-200/60 rounded-2xl p-5 sm:p-8 flex flex-col justify-between hover:shadow-md transition-shadow">
                  <div>
                    <div className="p-2.5 sm:p-3 bg-primary text-white rounded-xl inline-block mb-4 sm:mb-6">
      ...
      {/* 4. Methodology (5D) */}
      <section className="py-8 sm:py-20 bg-primary text-white border-t border-b border-[#D98A10]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-16 space-y-2 sm:space-y-3">
            <span className="text-xs font-bold tracking-widest text-[#D98A10] uppercase font-sans">Operational Journey</span>
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-white">The MSME 5D Implementation Process</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 sm:gap-6 max-w-5xl mx-auto">
            {methodologySteps.map((step, idx) => (
              <div key={idx} className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 relative">
                <span className="font-serif text-3xl sm:text-4xl font-bold text-white/10 absolute top-3 sm:top-4 right-3 sm:right-4 leading-none">0{idx + 1}</span>
                <span className="text-xs font-bold text-[#D98A10] tracking-wider block mb-1.5 sm:mb-2">{step.step}</span>
                <h3 className="font-serif text-sm sm:text-base font-bold text-white mb-1.5 sm:mb-2">{step.title}</h3>
      ...
      <section id="healthcheck-tool" className="py-8 sm:py-20 bg-slate-50/50 scroll-mt-20 border-t border-slate-100">
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-12 relative overflow-hidden flex flex-col md:flex-row items-center gap-6 sm:gap-8">
            ...
            <div className="shrink-0 w-full md:w-auto text-center md:text-left relative z-10">
              <Link 
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 bg-[#0C1D4A] hover:bg-[#071333] text-white px-6 sm:px-8 py-3.5 sm:py-4.5 rounded-xl font-bold text-xs uppercase tracking-wider transition-all shadow-md hover:shadow-lg"
              >
      ...
      <section className="py-8 sm:py-20 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-16 space-y-2 sm:space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-primary">MSME HR &amp; Recruitment Gaps</h2>
          ...
          <div className="max-w-5xl mx-auto space-y-4 sm:space-y-8">
            ...
            <div className="flex border-b border-slate-200">
              {[
                ...
                <button
                  ...
                  className={`flex-1 text-center py-2.5 sm:py-3.5 text-[11px] sm:text-sm font-bold uppercase tracking-wider border-b-2 transition-all cursor-pointer ${
                    activeStageTab === idx
            ...
            {/* Tab Body */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 pt-2 sm:pt-4">
              {/* Mistakes Column */}
              <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-4 sm:p-6 space-y-3 sm:space-y-4">
                <div className="flex items-center space-x-2 text-red-600">
                  <span className="text-xs sm:text-sm font-bold uppercase tracking-wider font-sans">Common Mistakes</span>
                </div>
                <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-slate-700 leading-relaxed list-disc pl-4">
              ...
              <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-4 sm:p-6 space-y-3 sm:space-y-4">
                <div className="flex items-center space-x-2 text-orange-600">
                  <span className="text-xs sm:text-sm font-bold uppercase tracking-wider font-sans">Consequences</span>
                </div>
                <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-slate-700 leading-relaxed list-disc pl-4">
              ...
              {/* Remedies Column */}
              <div className="bg-amber-50/30 border border-amber-200/60 rounded-2xl p-4 sm:p-6 space-y-3 sm:space-y-4">
                <div className="flex items-center space-x-2 text-emerald-600">
                  <span className="text-xs sm:text-sm font-bold uppercase tracking-wider font-sans">Remedies &amp; Solutions</span>
                </div>
                <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-slate-700 leading-relaxed list-disc pl-4">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 sm:p-8 mt-6 sm:mt-12 space-y-4 sm:space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-3 sm:pb-4 gap-2">
                <h3 className="font-serif text-base sm:text-lg font-bold text-primary">MSME Recruitment Best Practices</h3>
                <Link
