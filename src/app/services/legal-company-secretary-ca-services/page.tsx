      ...
      <section className="py-8 sm:py-20 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-16 space-y-2 sm:space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-primary">Statutory &amp; Administrative Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 max-w-5xl mx-auto">
            {supports.map((s, idx) => {
              const Icon = s.icon;
              return (
                <div key={idx} className="bg-white border border-slate-200/60 rounded-2xl p-5 sm:p-8 flex items-start space-x-4 sm:space-x-6 hover:shadow-md transition-shadow">
                  <div className="p-2.5 sm:p-3 bg-primary text-white rounded-xl shrink-0">
                    <Icon className="h-4 w-4 sm:h-5 sm:w-5 stroke-[2]" />
                  </div>
                  <div className="space-y-1.5 sm:space-y-2">
                    <h3 className="font-serif text-base sm:text-lg font-bold text-primary">{s.title}</h3>
      ...
      <section className="py-8 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-16 space-y-2 sm:space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-primary">Integrated Advisory Team</h2>
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed max-w-md mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 max-w-5xl mx-auto">
            {specialists.map((sp, idx) => (
              <div key={idx} className="bg-slate-50/50 border border-slate-200/50 rounded-xl p-4 sm:p-6 space-y-1.5 sm:space-y-2">
      ...
      <section className="py-8 sm:py-20 bg-primary text-white border-t border-b border-[#D98A10]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-16 space-y-2 sm:space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-white">Our Support Coordination Model</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 sm:gap-6 max-w-5xl mx-auto">
            {processFlow.map((flow, idx) => (
              <div key={idx} className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 relative">
                ...
                <span className="text-xs font-bold text-[#D98A10] tracking-wider block mb-1.5 sm:mb-2 uppercase">{flow.step}</span>
