...
export default function DefenceAerospaceClinicPage() {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-8 sm:py-20 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-16 space-y-2 sm:space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-primary">Defence &amp; Industrial Facilitation</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {positioning.map((pos, idx) => {
              const Icon = pos.icon;
              return (
                <div key={idx} className="bg-white border border-slate-200/60 rounded-xl p-5 sm:p-8 shadow-xs hover:shadow-md transition-shadow">
                  <div className="space-y-3 sm:space-y-4">
                    <div className="p-2.5 sm:p-3 bg-amber-50 text-[#D98A10] rounded-xl inline-block border border-amber-200">
                      <Icon className="h-4 w-4 sm:h-5 sm:w-5 shrink-0" />
                    </div>
                    <h3 className="font-serif text-base sm:text-lg font-bold text-primary">{pos.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-4 sm:space-y-6">
              <div className="border-l-4 border-[#D98A10] pl-4 space-y-1.5 sm:space-y-2">
                <span className="text-xs font-bold tracking-widest text-[#D98A10] uppercase">Proven Leadership</span>
                <h2 className="text-2xl sm:text-3xl font-serif font-bold text-primary">{founderBackground.name}</h2>
            ...
            {/* Right: Key Projects */}
            <div className="lg:col-span-6 bg-slate-50 border border-slate-200/80 rounded-2xl p-5 sm:p-8 space-y-4 sm:space-y-6">
              <h3 className="font-serif text-base sm:text-lg font-bold text-primary border-b border-slate-200 pb-3">Strategic Project Experience</h3>
              <div className="space-y-3 sm:space-y-4">
                {founderBackground.projects.map((proj, idx) => (
                  <div key={idx} className="flex items-start space-x-3 text-xs sm:text-sm text-slate-700 font-medium">
                    <div className="w-5 h-5 rounded-full bg-primary text-white flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">
                      {idx + 1}
                    </div>
                    <span>{proj}</span>
                  </div>
      ...
      <section className="py-8 sm:py-20 bg-slate-50/50 border-t border-b border-slate-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-16 space-y-2 sm:space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-primary">Indian Defence Regulatory Requirements</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
            <div className="bg-white p-5 sm:p-8 rounded-2xl border border-slate-200/60 space-y-3 sm:space-y-4">
              <h3 className="font-serif text-base sm:text-lg font-bold text-primary">Defence Industrial Licensing</h3>
            ...
            <div className="bg-white p-5 sm:p-8 rounded-2xl border border-slate-200/60 space-y-3 sm:space-y-4">
              <h3 className="font-serif text-base sm:text-lg font-bold text-primary">DoT / WPC Wireless Authorization</h3>
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
      ...
      <section className="py-8 sm:py-20 bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12">
            ...
            <div className="lg:col-span-7 space-y-6 sm:space-y-8">
              <div className="border-l-4 border-[#D98A10] pl-4 space-y-1.5 sm:space-y-2">
                ...
                <h3 className="text-xl sm:text-2xl font-serif font-bold text-primary">DIL Licensing Process Flow</h3>
                <p className="text-slate-600 text-xs sm:text-sm">
                  The sequential roadmap for securing a Defence Industrial License (DIL) under the DPIIT and Ministry of Defence.
                </p>
              </div>

              <div className="relative border-l border-slate-200 ml-3 sm:ml-4 pl-5 sm:pl-6 space-y-5 sm:space-y-6">
                {[
                  ...
                  <div key={idx} className="relative">
                    <span className="absolute -left-[29px] sm:-left-[35px] top-0.5 bg-primary text-white text-[10px] sm:text-xs font-bold w-4 h-4 sm:w-[18px] sm:h-[18px] rounded-full flex items-center justify-center border border-white">
                      {item.step}
                    </span>
