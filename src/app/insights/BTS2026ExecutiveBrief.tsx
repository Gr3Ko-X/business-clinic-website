      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <article className="bg-white border border-slate-200/80 shadow-md rounded-lg p-6 sm:p-12 lg:p-16 print:shadow-none print:border-none print:p-0 text-slate-800">
          ...
          <header className="border-b border-slate-200 pb-8 mb-8 text-center sm:text-left">
            <div className="inline-flex items-center space-x-2 px-3 py-1 bg-amber-50 border border-amber-200/80 rounded text-[11px] font-bold text-amber-900 uppercase tracking-widest mb-4">
              <Sparkles className="w-3.5 h-3.5 text-amber-700" />
              <span>Special Executive Briefing</span>
            </div>

            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold text-[#0C1D4A] tracking-tight leading-tight mb-4">
          ...
          {/* Table of Contents */}
          <nav aria-label="Table of contents" className="mb-10 p-5 bg-slate-50 border border-slate-200/90 rounded-lg print:hidden">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5 text-xs sm:text-sm">
              ...
              <a href="#business-clinic-help" className="text-slate-600 hover:text-[#D98A10] transition-colors py-0.5 flex items-center space-x-2">
                <span className="w-1.5 h-1.5 rounded-full bg-slate-300"></span>
                <span>How Business Clinic Can Help</span>
              </a>
          ...
          {/* Document Body */}
          <div className="space-y-10 text-[15px] sm:text-[16px] leading-relaxed text-slate-700 font-normal [&_p]:text-justify [&_p]:[text-justify:inter-word] [&_li]:text-justify">
            
            {/* Section: Executive Summary */}
            <section id="executive-summary" className="space-y-4 scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-serif font-bold text-[#0C1D4A] pb-1 border-b border-slate-100 text-left">
                Executive Summary
              </h2>
              <p>
              ...
              {/* Bold Business Clinic Callout (Exact from PDF) */}
              <div className="p-5 sm:p-6 bg-[#0C1D4A]/5 border-l-4 border-[#D98A10] rounded-r-md text-[#0C1D4A] font-medium leading-relaxed my-6 text-justify [text-justify:inter-word]">
                Business Clinic can help companies turn BTS 2026 from a networking event into a 
                ...
                Business Clinic helps companies identify the right people, qualify opportunities and 
            ...
            <section id="3x3x3-focus" className="space-y-6 scroll-mt-8">
              ...
              <div className="space-y-4 pt-2">
                <h3 className="text-lg font-bold text-slate-900 flex items-center space-x-2">
                  <span className="w-6 h-6 rounded-full bg-[#0C1D4A] text-white flex items-center justify-center text-xs font-bold">1</span>
                ...
                <p className="italic text-slate-700 bg-slate-50 p-3.5 rounded border border-slate-200 text-sm">
              ...
              <div className="space-y-4 pt-4">
                <h3 className="text-lg font-bold text-slate-900 flex items-center space-x-2">
                  <span className="w-6 h-6 rounded-full bg-[#0C1D4A] text-white flex items-center justify-center text-xs font-bold">2</span>
                  <span>3 Actions during BTS</span>
                </h3>

                <div className="space-y-6 pl-8 border-l-2 border-slate-200 ml-3">
                  <div>
                    <h4 className="font-semibold text-slate-900 mb-2">
                      DISCOVER — Build the funnel before BTS 6–8 weeks before the summit:
                    </h4>
                    <ul className="list-disc list-outside pl-5 space-y-1.5 text-slate-600">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mb-3">For every promising prospect:</p>

                    {/* Visual Meeting Ladder */}
                    <div id="meeting-ladder" className="bg-slate-50 border border-slate-200 rounded-lg p-5 my-3 scroll-mt-8">
                      <div className="space-y-3 font-mono text-xs sm:text-sm">
                        <div className="flex items-center space-x-3 bg-white p-2.5 rounded border border-slate-200">
                          <span className="px-2 py-0.5 bg-[#0C1D4A] text-white font-bold rounded text-xs">Level 1</span>
                        ...
                        <div className="flex items-center space-x-3 bg-white p-2.5 rounded border border-slate-200">
                          <span className="px-2 py-0.5 bg-[#0C1D4A] text-white font-bold rounded text-xs">Level 2</span>
                          <span className="text-slate-800 font-medium">30-minute business/technical discussion</span>
                        </div>
                        <div className="text-center text-slate-400 font-bold">↓</div>
                        <div className="flex items-center space-x-3 bg-white p-2.5 rounded border border-slate-200">
                          <span className="px-2 py-0.5 bg-[#0C1D4A] text-white font-bold rounded text-xs">Level 3</span>
                          <span className="text-slate-800 font-medium">Post-BTS virtual meeting</span>
                        </div>
                        <div className="text-center text-slate-400 font-bold">↓</div>
                        <div className="flex items-center space-x-3 bg-white p-2.5 rounded border border-slate-200">
                          <span className="px-2 py-0.5 bg-[#0C1D4A] text-white font-bold rounded text-xs">Level 4</span>
                          <span className="text-slate-800 font-medium">NDA / technical due diligence</span>
                        </div>
                        <div className="text-center text-slate-400 font-bold">↓</div>
                        <div className="flex items-center space-x-3 bg-amber-50 p-2.5 rounded border border-amber-300">
                          <span className="px-2 py-0.5 bg-[#D98A10] text-white font-bold rounded text-xs">Level 5</span>
                          <span className="text-slate-900 font-bold">Pilot, distribution agreement, JV, investment or India-entry project.</span>
                        </div>
                      </div>
                    </div>

                    <ul className="list-disc list-outside pl-5 space-y-1.5 text-slate-600 mt-3">
              ...
              <div className="space-y-4 pt-4">
                <h3 className="text-lg font-bold text-slate-900 flex items-center space-x-2">
                  <span className="w-6 h-6 rounded-full bg-[#0C1D4A] text-white flex items-center justify-center text-xs font-bold">3</span>
                  <span>3 outcomes after BTS</span>
                </h3>

                <ul className="list-disc list-outside pl-8 space-y-2 text-slate-600 ml-3 border-l-2 border-slate-200">
                  <li>
            ...
            <section id="msme-startups" className="space-y-4 pt-4 border-t border-slate-200 scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-serif font-bold text-[#0C1D4A]">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-md p-5 space-y-5">
                ...
                <div className="space-y-4 text-sm">
                  <div>
                    ...
                    <ul className="list-disc list-outside pl-6 space-y-0.5 text-slate-600">
            ...
            <section id="kpi-funnel" className="space-y-4 scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-serif font-bold text-[#0C1D4A]">
                A useful KPI
              </h2>

              <div className="bg-gradient-to-r from-[#0C1D4A] to-[#142A63] text-white p-6 rounded-lg shadow-md space-y-3">
                <div className="text-xs uppercase tracking-widest text-amber-400 font-bold">
                  Recommended Performance Conversion Funnel
                </div>
                <div className="text-base sm:text-lg lg:text-xl font-mono font-bold tracking-tight text-white py-1">
            ...
            {/* Section: How Business Clinic Can Help You Exploit BTS 2026 */}
            <section id="business-clinic-help" className="space-y-4 pt-2 scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-serif font-bold text-[#0C1D4A] pb-1 border-b border-slate-100">
                How Business Clinic Can Help You Exploit BTS 2026
              </h2>
              <p>
                Business Clinic helps companies move from <em>attending BTS</em> to <em>converting BTS into business</em>. 
            ...
            {/* Section: Summing Up */}
            <section id="summing-up" className="space-y-4 pt-2 scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-serif font-bold text-[#0C1D4A] pb-1 border-b border-slate-100">
                Summing Up
              </h2>
              <p>
            ...
            {/* Author Footer Card */}
            <div className="mt-12 pt-8 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-50 p-6 rounded-lg print:hidden">
              <div>
                <h4 className="font-serif font-bold text-slate-900 text-base">
                  Sanjay Chandra
                </h4>
                <p className="text-xs text-slate-600">
                  Business Clinic Advisory • Industrial &amp; India Entry Strategy
                </p>
              </div>

              <Link
                href="/contact"
                className="inline-flex items-center space-x-2 bg-[#0C1D4A] hover:bg-[#142A63] text-white px-5 py-2.5 rounded font-semibold text-xs transition-colors uppercase tracking-wider shadow-sm"
              >
