...
export default function BengaluruTechSummit2026Page() {
  return (
    <div className="bg-[#f8fafc] text-slate-800 pb-20 lg:pb-0">
      ...
      {/* Assessment */}
      <section className="py-8 sm:py-20 border-b border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-6 sm:mb-12">
            <span className="text-xs sm:text-sm font-bold tracking-[0.18em] text-[#c58f1a] uppercase">
              India Entry Advisory
            </span>
            <h2 className="font-serif font-bold text-xl sm:text-3xl lg:text-4xl text-[#0c1d4a] mt-1.5 sm:mt-2 leading-tight">
              We can help you assess:
            </h2>
            <p className="text-slate-600 text-xs sm:text-base mt-2 sm:mt-3 leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-5">
            {BTS_ASSESSMENT_ITEMS.map((item, idx) => {
              ...
              return (
                <div
                  key={item.title}
                  className="group flex gap-3.5 sm:gap-4 p-4 sm:p-6 bg-white border border-slate-200/80 rounded-xl hover:border-[#c58f1a]/40 hover:shadow-md transition-all duration-200"
                  style={{ animationDelay: `${idx * 80}ms` }}
                >
                  <div className="shrink-0 w-9 h-9 sm:w-11 sm:h-11 rounded-lg sm:rounded-xl bg-[#0c1d4a]/5 border border-[#0c1d4a]/10 flex items-center justify-center text-[#c58f1a] group-hover:bg-[#c58f1a]/10 transition-colors">
                    <Icon className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <div className="space-y-0.5 sm:space-y-1 min-w-0">
                    <h3 className="font-serif font-bold text-[#0c1d4a] text-sm sm:text-base leading-snug">
                      {item.title}
                    </h3>
      ...
      {/* Meet at BTS */}
      <section id="meet" className="py-8 sm:py-20 bg-[#0c1d4a] text-white scroll-mt-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-16 items-center">
            <div className="space-y-3.5 sm:space-y-5">
              ...
              <h2 className="font-serif font-bold text-xl sm:text-3xl lg:text-4xl leading-tight">
                Meet us at BTS 2026
              </h2>
              <p className="text-slate-300 text-xs sm:text-base leading-relaxed max-w-lg">
                Schedule a 30-minute India Entry discussion with India Business Clinic during
              ...
              <ul className="space-y-2 sm:space-y-3 pt-1 sm:pt-2">
                {[
                  ...
                  <li key={point} className="flex items-start gap-2.5 text-xs sm:text-sm text-slate-200">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#c58f1a] shrink-0 mt-1.5 sm:mt-2" />
                    <span>{point}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-8 space-y-4 sm:space-y-6">
              <div className="grid grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm">
                <div>
                  <p className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-slate-400 mb-0.5 sm:mb-1">
                    Dates
                  </p>
              ...
              <Link
                ...
                className="w-full inline-flex items-center justify-center gap-2 bg-[#c58f1a] hover:bg-[#a37210] text-white font-bold py-3 sm:py-3.5 px-4 sm:px-6 rounded-lg text-xs sm:text-sm transition-all active:scale-[0.98]"
              >
      ...
      <section className="py-8 sm:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4 sm:space-y-6">
          <h2 className="font-serif font-bold text-xl sm:text-3xl text-[#0c1d4a] leading-tight">
            Ready to explore India with execution-focused guidance?
          </h2>
          <p className="text-slate-600 text-xs sm:text-base leading-relaxed">
            India Business Clinic is the industrial advisory and India entry division of Spuntech
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2.5 sm:gap-4 pt-1 sm:pt-2">
            <Link
              href={BTS_CONTACT_HREF}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#0c1d4a] hover:bg-[#071333] text-white font-bold px-6 sm:px-8 py-3 sm:py-3.5 rounded-lg text-xs sm:text-sm transition-all shadow-md active:scale-[0.98]"
            >
            ...
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border-2 border-slate-300 hover:border-[#0c1d4a] text-[#0c1d4a] font-bold px-6 sm:px-8 py-3 sm:py-3.5 rounded-lg text-xs sm:text-sm transition-all active:scale-[0.98]"
            >
      ...
      {/* Trust strip */}
      <section className="py-6 sm:py-12 bg-slate-50 border-t border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
