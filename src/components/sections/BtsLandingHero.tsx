...
export default function BtsLandingHero() {
  return (
    <section className="relative min-h-0 sm:min-h-[85dvh] flex items-center overflow-hidden">
      <Image
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 lg:gap-14 items-center">
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left">
            <p className="inline-flex items-center gap-2 text-xs sm:text-xs font-bold tracking-[0.2em] text-[#c58f1a] uppercase">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-2.5 sm:gap-4 pt-1 sm:pt-2">
              <Link
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-[#c58f1a] hover:bg-[#a37210] text-white font-bold px-5 sm:px-7 py-2.5 sm:py-3.5 rounded-lg text-xs sm:text-sm transition-all duration-200 shadow-lg shadow-[#c58f1a]/25 hover:-translate-y-0.5 active:scale-[0.98]"
              >
              ...
              <a
                href="#meet"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border-2 border-white/50 hover:border-white bg-white/5 hover:bg-white/10 text-white font-bold px-5 sm:px-7 py-2.5 sm:py-3.5 rounded-lg text-xs sm:text-sm transition-all backdrop-blur-sm active:scale-[0.98]"
              >
          ...
          <div className="lg:col-span-5">
            <div className="bg-white/10 backdrop-blur-md border border-white/15 rounded-xl sm:rounded-2xl p-4 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.25)] space-y-3.5 sm:space-y-5">
